...
if (window.jQuery)
    (function($) {
        ...
        function readData(element, data) {
            var dataval = urlParams[data];
            if (dataval == null) {
                dataval = $(element).data(data);
            }
            return dataval;
        };
        ...
        TC_Instance.prototype.start = function() {
            ...
            var attr_data_date = readData(this.element, 'date');
            if (typeof attr_data_date === "undefined") {
                attr_data_date = $(this.element).attr('data-date');
            }
            if (typeof attr_data_date === "string") {
                this.data.attributes.ref_date = Date.parse(attr_data_date); //parse_date(attr_data_date);
